...
export class SupplierStatsComponent implements OnInit {
  ...
  fetchSupplierStats() {
    this.http.get<any>('http://localhost:8092/SupplierContracts/api/suppliers/financial-health').subscribe(
      (data) => {
  ...
  fetchSupplierStatusDistribution() {
    this.http.get<{ [key: string]: number }>('http://localhost:8092/SupplierContracts/api/suppliers/status-distribution').subscribe(
      (data) => {
  ...
  fetchTop5Suppliers() {
    this.http.get<Supplier[]>('http://localhost:8092/SupplierContracts/api/suppliers/top5-by-reliability').subscribe(
      (data) => {
  ...
  fetchNewSuppliersLast30Days() {
    this.http.get<Supplier[]>('http://localhost:8092/SupplierContracts/api/suppliers/new-suppliers-last-30-days').subscribe(
      (data) => {
  ...
  fetchRecentlyUpdatedSuppliers() {
    this.http.get<Supplier[]>('http://localhost:8092/SupplierContracts/api/suppliers/recently-updated-suppliers').subscribe(
      (data) => {
